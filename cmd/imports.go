...
import (
	_ "github.com/cemililik/leakwatch/internal/verifier/airtable"     // register airtable verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/anthropic"    // register anthropic verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/auth0"        // register auth0 verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/aws"          // register aws STS verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/azure"        // register azure verifiers (storage + entra)
	_ "github.com/cemililik/leakwatch/internal/verifier/bitbucket"    // register bitbucket verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/circleci"     // register circleci verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/cloudflare"   // register cloudflare verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/coinbase"     // register coinbase verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/databricks"   // register databricks verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/datadog"      // register datadog verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/deepseek"     // register deepseek verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/digitalocean" // register digitalocean verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/discord"      // register discord verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/dockerhub"    // register dockerhub verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/doppler"      // register doppler verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/figma"        // register figma verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/gcp"          // register gcp verifier (format validation)
	_ "github.com/cemililik/leakwatch/internal/verifier/github"       // register github verifiers (pat + oauth)
	_ "github.com/cemililik/leakwatch/internal/verifier/gitlab"       // register gitlab verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/grafana"      // register grafana verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/heroku"       // register heroku verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/huggingface"  // register huggingface verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/infura"       // register infura verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/launchdarkly" // register launchdarkly verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/linear"       // register linear verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/mailgun"      // register mailgun verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/newrelic"     // register newrelic verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/notion"       // register notion verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/npm"          // register npm verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/okta"         // register okta verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/openai"       // register openai verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/pagerduty"    // register pagerduty verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/postmark"     // register postmark verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/pypi"         // register pypi verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/rabbitmq"     // register rabbitmq verifier (format validation)
	_ "github.com/cemililik/leakwatch/internal/verifier/rubygems"     // register rubygems verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/sendgrid"     // register sendgrid verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/sentry"       // register sentry verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/shopify"      // register shopify verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/slack"        // register slack verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/snowflake"    // register snowflake verifier (format validation)
	_ "github.com/cemililik/leakwatch/internal/verifier/snyk"         // register snyk verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/sonarcloud"   // register sonarcloud verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/stripe"       // register stripe verifiers (live + test)
	_ "github.com/cemililik/leakwatch/internal/verifier/supabase"     // register supabase verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/teams"        // register microsoft teams webhook verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/telegram"     // register telegram verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/terraform"    // register terraform cloud verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/twilio"       // register twilio verifier
	_ "github.com/cemililik/leakwatch/internal/verifier/vercel"       // register vercel verifier
)
